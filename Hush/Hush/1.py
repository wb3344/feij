...
def main():
    ...
    pygame.display.set_icon(pygame.image.load(r'C:\Users\14212\Desktop\Hush\gameicon.png'))
    DISPLAYSURF = pygame.display.set_mode((WINWIDTH, WINHEIGHT))
    pygame.display.set_caption('Squirrel Eat Squirrel')
    BASICFONT = pygame.font.Font(r'C:\Users\14212\Desktop\Hush\freesansbold.ttf', 32)

    # load the image files
    L_SQUIR_IMG = pygame.image.load(r'C:\Users\14212\Desktop\Hush\squirrel.png')
    R_SQUIR_IMG = pygame.transform.flip(L_SQUIR_IMG, True, False)
    GRASSIMAGES = []
    for i in range(1, 5):
        GRASSIMAGES.append(pygame.image.load(r'C:\Users\14212\Desktop\Hush\grass%s.png' % i))
